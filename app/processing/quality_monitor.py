...
class QualityMonitor:
    ...
    def __init__(self):
        ...
        self.quality_rules = {
            ...
            'valid_experience_levels': [
                'Entry level', 'Mid level', 'Senior level', 'Not specified'
            ]
        }
    ...
    def validate_data_completeness(self, processed_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for field in all_fields:
            populated_count = sum(1 for job in processed_data 
    ...
    def recommend_improvements(self, quality_issues: Dict[str, Any]) -> List[str]:
        ...
        if anomaly_rate > 10:
            recommendations.append(f"High anomaly rate ({anomaly_rate:.1f}%). Review data sources and validation rules.")
