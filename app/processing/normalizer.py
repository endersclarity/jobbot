...
class DataNormalizer:
    ...
    def standardize_locations(self, location_text: str) -> Dict[str, str]:
        ...
        if is_remote:
            return {"city": "Remote", "state": "", "is_remote": True}
        ...
        if location_match:
            ...
            return {"city": city, "state": state, "is_remote": False}

        # Fallback: treat as city if no comma found
        return {"city": location_text.title(), "state": "", "is_remote": False}
    ...
    def extract_industry_from_description(self, description_text: str, company_name: str = "") -> str:
        ...
        industry_keywords = {
            ...
            "Retail": ["retail", "sales", "customer service", "store", "merchandise", "e-commerce", "shopping"],
            "Manufacturing": [
                "manufacturing",
                "production",
                "factory",
    ...
    def normalize_all_fields(self, job_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Extract industry
        normalized["industry"] = self.extract_industry_from_description(description, job_data.get("company", ""))
